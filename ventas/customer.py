class Client:
    ...
    def show(self):
        ...
        print('   Nombres    Dni')
        print(f'{self.first_name} {self.last_name}  {self.dni}')    
...
class RegularClient(Client):
    def __init__(self, first_name="Cliente", last_name="Final", dni="9999999999", card=False):
        ...
        self.__discount = 0.10 if card else 0.05  # Descuento del cliente regular
