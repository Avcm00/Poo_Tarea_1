...
if __name__ == '__main__':
    ...
    class Product:
        ...
        def __init__(self, id: int = 0, descrip: str = "Ninguno", preci: float = 0, stock: int = 0) -> None:
            ...
            self.__stock: int = stock  # Atributo privado para almacenar el número de identificación del cliente
        ...
        def getJson(self) -> Dict[str, Union[int, str, float]]:
            # Método especial para representar la clase Cliente como una cadena
            return {"id": self.__id, "descripcion": self.descrip, "precio": self.preci, "stock": self.stock}
    ...
    if __name__ == '__main__':
        ...
        product1: Product = Product("Aceite", 2, 1000)
        product2: Product = Product("Colas", 3, 5000)
        product3: Product = Product("leche", 1, 300)
        ...
        # print(products)
        prods: List[Dict[str, Union[int, str, float]]] = []
